...
namespace EI.Config
{
    //public class ProberIdListData : ValueListData<string>
    //{
    //    #region constructors

    //    public ProberIdListData(ConfigType configType, string prefix, string name, string description, string editor, string itemPrefix, string itemDescription)
