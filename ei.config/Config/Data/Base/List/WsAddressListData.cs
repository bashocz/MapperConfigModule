...
namespace EI.Config
{
    //public class WsAddressListData : ValueListData<string>
    //{
    //    #region constructors

    //    public WsAddressListData(ConfigType configType, string prefix, string name, string description, string editor, string itemPrefix, string itemDescription)
